...
public class TrackGameManagerTest {
	...
	public void testExchange() {
		...
		tgm.add(a7);
		tgm.setRaceType("100");
		tgm.setTrackNumber(3);
		tgm.grouping(new DividerAscendingOrder());
		
		List<List<Athlete>> group = new ArrayList<List<Athlete>>();
		group.add(Arrays.asList(a2,a6,a5));
		group.add(Arrays.asList(a7,a1,a4));
		group.add(Arrays.asList(a3));
		
		List<List<Athlete>> group1 = new ArrayList<List<Athlete>>();
		group1.add(Arrays.asList(a6,a2,a5));
		group1.add(Arrays.asList(a7,a1,a4));
		group1.add(Arrays.asList(a3));
		
		List<List<Athlete>> group2 = new ArrayList<List<Athlete>>();
		group2.add(Arrays.asList(a2,a6,a3));
		group2.add(Arrays.asList(a7,a1,a4));
		group2.add(Arrays.asList(a5));
	...
	public void testIndexOfGroup() {
		...
		assertEquals(2, tgm.indexOfGroup(a3));
	...
	public void testBuildeTrackGames() {
		...
		//a2 should be in 1st group and 1st track(the inside)
		assertEquals(a2, tgs.get(0).getObjects(0).get(0));
		//a3 should be in last group and 1st track(the inside)
		assertEquals(a3, tgs.get(2).getObjects(0).get(0));
