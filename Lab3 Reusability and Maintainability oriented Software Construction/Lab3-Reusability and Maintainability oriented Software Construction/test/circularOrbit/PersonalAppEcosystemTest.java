...
public class PersonalAppEcosystemTest {
	...
	public void testAddIntalling() {
		PersonalAppEcosystem pae = new PersonalAppEcosystem("a1", t);
		pae.addCentralPoint(new Person("AN"));
		AppFactory af = new AppFactory();
		App a = (App)af.create("App ::= <Wechat,Tencent,13.2,\"The most popular social networking App in China\",\"Social network\">");
		AppInstallTime at = new AppInstallTime();
		at.add(t);
		App b = (App)af.create("App ::= <QQ,Tencent,29.2,\"The second popular social networking App in China\",\"Social network\">");
		AppInstallTime bt = new AppInstallTime();
		bt.add(t);
		App c = (App)af.create("App ::= <Weibo,Sina,v0.2.3.4,\"The third popular social networking App in China\",\"Social network\">");
		AppInstallTime ct = new AppInstallTime();
		ct.add(t);
		App d = (App)af.create("App ::= <Didi,Didi,ver03.32,\"The most popular car sharing App in China\",\"Travel\">");
	...
	public void testToString() {
		...
		assertEquals("[PersonalAppEcosystem:a1, Duration:[2016-02-18T12:50:00Z...2016-02-18T13:00:00Z], TrackNumber:3]\n" + 
