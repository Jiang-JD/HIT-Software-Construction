...
public class MementoCareTaker {
	private final List<MementoTransit> memento = new ArrayList<MementoTransit>();
	 ...
	 */
	public boolean add(MementoTransit m) {
	 ...
	 */
	public MementoTransit get(int index) {
	 ...
	 */
	public boolean remove(MementoTransit m) {
		if(m == null) return false;
	 ...
	 */
	public boolean contains(MementoTransit m) {
		if(m == null) return false;
