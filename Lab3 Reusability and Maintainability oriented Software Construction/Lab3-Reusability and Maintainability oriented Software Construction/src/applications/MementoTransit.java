...
public class MementoTransit {
	 ...
	 * @param cp 中心原子核，要求非空
	 */
	public MementoTransit(List<Track> tracks ,Map<Track,List<Electron>> trackmap ,Nucleus cp) {
	...
	public boolean equals(Object otherobject) {
		...
		MementoTransit other = (MementoTransit)otherobject;
