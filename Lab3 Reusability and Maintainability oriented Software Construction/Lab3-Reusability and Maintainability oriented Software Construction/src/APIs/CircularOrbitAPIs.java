...
public class CircularOrbitAPIs<E> {
	...
	public int getLogicalDistance (CircularOrbit c, E e1, E e2) {
		if(e1 == null || e2 == null) throw new IllegalArgumentException("getLogicalDistance argument is null pointer");
		E base = e1;
		E target = e2;
	...
	public double getPhysicalDistance (CircularOrbit c, E e1, E e2) {
		if(e1 == null || e2 == null) throw new IllegalArgumentException("getPhysicalDistance argument is null pointer");
		E base = e1;
		E target = e2;
		List<E> vertex = new ArrayList<E>();
		@SuppressWarnings("unchecked")
	...
	public Difference getDifference (CircularOrbit c1, CircularOrbit c2) {
		if(c1 == null || c2 == null) throw new IllegalArgumentException("Null pointer in c1 or c2");
