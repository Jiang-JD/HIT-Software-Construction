...
public class Athlete extends PhysicalObject{
	...
	private void checkRep() {
		...
		assert nation.matches(Regex.TRACKGAME_NATION) : "Athlete Nation is not consist of 3 captive character";
	...
	public String toString() {
		return "[Athlete: name:"+name+", age:"+age+", number:"+number
				+", nation:"+nation+", personal best:"+pb+"]";
	}
	
	/**
	 * 将其他的对象与当前的Athlete对象比较是否相等，比较其所有属性，若Athlete对象
	 * 与其他的对象在姓名，年龄，国籍，号码，成绩都相同，则判定为相等。
	 */
	@Override
