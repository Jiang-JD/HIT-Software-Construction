...
public class ConcreteAtomState implements State<Nucleus, Electron> {
	 ...
	 */
	@Override
	public MementoTransit backup(AtomStructure as) {
		return new MementoTransit(as.getTracks(), as.getTrackMap(), as.getCentralPoint());
	}
	 ...
	 */
	@Override
	public boolean restore(MementoTransit m, AtomStructure as) {
