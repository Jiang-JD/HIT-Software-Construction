...
public class Fx extends Application {
  ...
  private static final double centerradius = 22;
  private static final double orbitradius = 15;
  private static final double trackradius = 50;
   ...
   * @return 物体Circle
   */
  public static Circle addObj(Group root, String name, Circle track, 
                              boolean tidy, boolean showname) {
   ...
   * @return 物体Circle列表
   */
  public static List<Circle> addObjs(Group root, List<String> names, 
                                      Circle track, boolean tidy, 
                                      boolean showname) {
   ...
   * @return 物体Circle列表
   */
  public static List<Circle> addObjsEvenDistributed(Group root, List<String> names, 
                                                    Circle track, boolean showname) {
    List<Circle> li = new ArrayList<Circle>();
    // calculate obj position
    DoubleProperty r = track.radiusProperty();
    double angle = 0;
