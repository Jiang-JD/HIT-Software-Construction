...
/**.
 * 电子跃迁记录备忘录条目类，存储一次跃迁前的轨道系统状态 包括轨道信息，中心点，电子数量和所处轨道
 *
 */
public class Memento {
  ...
  public Memento(List<Track> tracks, Map<Track, List<Electron>> trackmap, Nucleus cp) {
    ...
    if (cp == null) {
      throw new NullPointerException("Nucleus is null pointer");
    }
  ...
  /**.
   * 将其他备忘录条目与当前备忘录条目进行比较，如果轨道集合，中心物体，映射关系和记录时间 都相同，则判断两个备忘录条目相同
   */
  @Override
  public boolean equals(Object otherobject) {
    ...
    return cp.equals(other.getNucleus()) 
        && tracks.equals(other.tracks) 
        && trackmap.equals(other.trackmap)
