...
/**.
 * {@code TrackGame} 是一场径赛，径赛是在田径场的跑道上进行的跑和 走的竞赛项目的统称，例如 100 米、200 米、400 米 、800
 * 米等项目。一 个标准的径赛场地通常由两个半径相等的半圆弯道和两个长度相等的直 段组成。{@code TrackGame} 中场地形状
...
public class TrackGame extends ConcreteCircularOrbit<CentralPoint, Athlete> implements Cloneable {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder(
        "[TrackGame:" + getName() + ", RaceType:" + racetype 
