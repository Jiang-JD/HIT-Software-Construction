...
/**.
 * {@code AtomStructure} 是一个原子结构模型。原子结构模型（AtomStructure）：一个原子由原子核和绕 核运动的电子
 * 组成，原子的质量主要集中在由质子和中子构成的原子核上，核外分布 着电子。原子可看作是以原子核为中心
 * 的多条电子轨道的结构。{@code AtomStructure} 将原子核作为整体看作中心点的物体，不考虑其内部的质
 * 子和中子。不考虑电子之间的关系。不考虑电子的绝对位置，也无需考虑 电子在轨道上的运动。 电子可以在不同轨道之间跃迁。由于原子在运行时结构可变，因此是
 * {@code mutable} 的。
 *
 * 
 */
public class AtomStructure extends ConcreteCircularOrbit<Nucleus, Electron> implements Cloneable {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder(
        "[AtomStructure:" + getName() + ", TrackNumber:" + getTrackNum() + "]\n");
