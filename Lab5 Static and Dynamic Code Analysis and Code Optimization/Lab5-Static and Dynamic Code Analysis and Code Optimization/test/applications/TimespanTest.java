...
public class TimespanTest {
  ...
  public void testOverlap() {
    ...
    final Timespan t1 = new Timespan(d1, d6);
    final Timespan t2 = new Timespan(d8, d5);
    final Timespan t3 = new Timespan(d6, d2);
    final Timespan t4 = new Timespan(d4, d8);
    final Timespan t5 = new Timespan(d1, d5);
    final Timespan t6 = new Timespan(d3, d7);
    final Timespan t7 = new Timespan(d6, d3);
    final Timespan t8 = new Timespan(d7, d8);
