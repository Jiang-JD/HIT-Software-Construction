...
public class CircularOrbitApisTest {
  ...
  public void testGetLogicDistance() {
    ConcreteCircularOrbit<CentralPoint, PhysicalObject> cco = 
        new ConcreteCircularOrbit<CentralPoint, PhysicalObject>(
        "A", new TestTrackFactory());
    int t1 = cco.addTrack(1);
    int t2 = cco.addTrack(2);
    int t3 = cco.addTrack(3);
    final PhysicalObjectFactory pf = new TestObjectFactory();
    final PhysicalObject a = pf.create("A");
    final PhysicalObject b = pf.create("B");
    final PhysicalObject c = pf.create("C");
    final PhysicalObject d = pf.create("D");
    final PhysicalObject e = pf.create("E");
    final PhysicalObject f = pf.create("F");
  ...
  /*
   * Covers: 1-1 2-1 3-1 max 1-3 2-0 3-0 min 1-0 2-2 3-1 1-2 2-0 3-1
   */
  @Test
  public void testGetObjectDistributionEntropy() {
    ...
    final double en1 = api.getObjectDistributionEntropy(cco);
    ...
    final double en2 = api.getObjectDistributionEntropy(cco);
    ...
    final double en3 = api.getObjectDistributionEntropy(cco);
    ...
    final double en4 = api.getObjectDistributionEntropy(cco);
