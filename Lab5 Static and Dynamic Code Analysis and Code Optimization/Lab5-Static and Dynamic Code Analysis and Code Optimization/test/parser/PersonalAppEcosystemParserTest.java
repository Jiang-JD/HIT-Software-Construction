...
public class PersonalAppEcosystemParserTest {
  ...
  String text = aep.getText("src/txt/PersonalAppEcosystem.txt");
  ...
  public void testGetAppInstallTime() {
    List<UsageLog> li = aep.getUsageLog(text);
  ...
  public void testGetApps() {
    Set<App> li = aep.getApps(text);

    assertEquals(6, li.size());
    App a = new App("Wechat", "Tencent", "13.2", 
        "\"The most popular social networking App in China\"",
        "\"Social network\"");
  ...
  public void testGetCompany() {
    String r = "App ::= <BaiduMap,Baidu,2.9000000.20v03,"
  ...
  public void testGetPeriod() {
    assertEquals(Period.Day, aep.getPeriod(text));
  }

  @Test
  public void testGetRelation() {
    List<Relation<String>> rel = aep.getRelation(text);
  ...
  public void testGetUser() {
    assertEquals("TimWong", aep.getUser(text));
  }
}
