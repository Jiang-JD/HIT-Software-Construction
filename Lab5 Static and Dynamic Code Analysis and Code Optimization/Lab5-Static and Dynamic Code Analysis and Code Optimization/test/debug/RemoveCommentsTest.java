...
public class RemoveCommentsTest {
  ...
  public void testRemoveSlashComment() {
    String[] withSlash = new String[] { "int main()", 
        "{", "    //declaration", "int a, b, c;", "a = b+c;", "}" };
    ...
    String[] withoutSlash = new String[] { "int main()", "{", "int a, b, c;", "a = b+c;", "}" };
  ...
  public void testRemoveAsteriskComment() {
    String[] withAsterisk = new String[] { "/* Test Program */", 
        "int main()", "{", "int a, b, c;", "/* multiline",
        "   comment ", "   test */", "a = b+c;", "}" };

    String[] withoutAsterisk = new String[] { "int main()", "{", "int a, b, c;", "a = b+c;", "}" };
  ...
  public void testRemoveCommentDividedString() {
    final String[] divide1 = new String[] { "a/* comment ", " test ", " for divided */b", };

    final String[] divide2 = new String[] { "a/* comment test */b" };

    final String[] divide3 = new String[] { "/* comment ", " test */b" };

    final String[] divide4 = new String[] { "a/* comment ", " test */" };
    ...
    final List<String> ans1 = new ArrayList<String>() {
      {
        add("a");
      }
    };
