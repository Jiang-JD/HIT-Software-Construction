...
public abstract class CircularOrbitTest<L,E> {
  ...
  public void testRemoveObject() {
    PhysicalObjectFactory pof = new TestObjectFactory();
    final PhysicalObject po1 = pof.create("A");
    final PhysicalObject po2 = pof.create("B");
    final PhysicalObject po4 = pof.create("A");
    final PhysicalObject po5 = pof.create("A");

    CircularOrbit<CentralPoint, PhysicalObject> co = emptyInstance();
    final int t1 = co.addTrack(1);
    final int t2 = co.addTrack(2);
  ...
  public void testRemoveObjectTrack() {
    PhysicalObjectFactory pof = new TestObjectFactory();
    final PhysicalObject po1 = pof.create("A");
    final PhysicalObject po2 = pof.create("A");
    final PhysicalObject po3 = pof.create("A");
  ...
  public void testAddCetralRelation() {
    ...
    CentralPointFactory cpf = new CentralPointFactory();
    final CentralPoint cp1 = (CentralPoint) cpf.create("A");
  ...
  public void testRemoveCentralRelation() {
    ...
    final PhysicalObject po1 = pof.create("A");
    final PhysicalObject po2 = pof.create("B");
    final PhysicalObject po3 = pof.create("C");
  ...
  public void testAddOrbitRelation() {
    ...
    assertTrue("Excepted dupilicate add true", co.addOrbitRelation(po1, po2));
  }
  ...
  public void testRemoveOrbitRelation() {
    ...
    final PhysicalObject po2 = pof.create("B");
    final PhysicalObject po3 = pof.create("C");
    final PhysicalObject po4 = pof.create("D");
  ...
  public void testRelatives() {
    ...
    final PhysicalObject po3 = pof.create("C");
    final PhysicalObject po4 = pof.create("D");
    final PhysicalObject po5 = pof.create("E");
  ...
  public void testIterator() {
    ...
    final Iterator<PhysicalObject> it = co.iterator();
