...
public class PersonalAppManagerTest {
  ...
  public void testGetDifference() {
    ...
    Timespan t1 = 
        new Timespan(Instant.parse("2019-01-01T16:00:00Z"), Instant.parse("2019-01-02T16:00:00Z"));
    Timespan t2 = 
        new Timespan(Instant.parse("2019-01-02T08:00:00Z"), Instant.parse("2019-01-03T23:00:00Z"));
  ...
  public void testAdd() {
    ...
    App a = new App("MOMO", "Tencent", "29.2", 
