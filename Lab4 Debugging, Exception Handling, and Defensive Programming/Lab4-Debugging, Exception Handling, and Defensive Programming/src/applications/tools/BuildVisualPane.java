...
//		cen.centerXProperty().bind(width.divide(2));
//		cen.centerYProperty().bind(height.divide(2));
...
//		cen.centerYProperty().bind(height.divide(2));
	 ...
	 * @return 物体Circle
	 */
	private static Circle addObj(Group root, String name, Circle track, boolean tidy, boolean showname) {
	 ...
	 * @return 物体Circle列表
	 */
	private static List<Circle> addObjs(Group root, List<String> names, Circle track, boolean tidy, boolean showname) {
	 ...
	 * @return 物体Circle列表
	 */
	private static List<Circle> addObjsEvenDistributed(Group root, List<String> names, Circle track, boolean showname) {
		List<Circle> li = new ArrayList<Circle>();
		// calculate obj position
		DoubleProperty r = track.radiusProperty();
		double angle = 0;
