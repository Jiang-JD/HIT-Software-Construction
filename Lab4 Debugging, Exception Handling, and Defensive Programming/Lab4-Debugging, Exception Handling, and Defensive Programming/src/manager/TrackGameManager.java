...
public class TrackGameManager {
	 ...
	 * 	所有域是private final的，返回的mutable变量例如List Map，方法grouping(), exchange()都做了防御性拷贝
	 *  
	 */
	 ...
	 */
	public boolean initial(String filePath) throws IllegalElementFormatException, NoSuchElementException
										, IncorrectElementLabelOrderException
										, LackOfComponentException
										, ElementLabelDuplicationException, TrackNumberOutOfRangeException {
		clear();
		TrackGameParser tgp = new TrackGameParser();
		tgp.parserFile(filePath);
	...
	public List<TrackGame> grouping(Divider divider) {
		if(divider == null) throw new NullPointerException("Divider is null object");
