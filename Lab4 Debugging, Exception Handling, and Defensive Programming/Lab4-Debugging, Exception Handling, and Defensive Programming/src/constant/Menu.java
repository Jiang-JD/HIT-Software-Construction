...
public class Menu {
	...
	public static String MENU_TRACKGAME = 
			...
			+   "0. 退出TrackGame\n"
			+	"============================\n";
	public static String INPUTCOMFIRM = 
				"输入图输入会使之前分组不再保存，是否继续（y/n）：\n";
	public static String TRACKGAME_DIVIDER = 
				"请选择分组策略：\n"
			+	"1. 随机分组\n"
			+ 	"2. 按照成绩由高到低排序\n";
	public static String TRACKGAME_EXCHANGE = 
				"请输入调换的两个运动员号码（正整数 空格分开）：\n";
	...
	public static String TRACKGAME_REMOVEATHLETE = 
				"请输入运动员编号和轨道索引，以 | 分割 ：\n";
	public static String MENU_ATOMSTRUCTURE = 
			...
			+	"0. 退出AtomStructure\n"
			+ 	"=============================\n";
	public static String ATOM_ADDELECTRON = 
				"请输入指定轨道索引，从0开始和电子数量：\n";
	public static String ATOM_REMOVEELECTRON = 
				"请输入指定轨道索引，从0开始和电子数量：\n";
	public static String ATOM_TRANSIT = 
				"请输入指定原轨道和新轨道索引，从0开始：\n";
	public static String ATOM_BACKUP = 
				"请输入备忘录编号或输入n返回\n";
