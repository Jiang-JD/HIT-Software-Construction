...
public class TrackGameTest extends ConcreteCircularOrbitTest {
	...
	public void testToString() {
		...
		String s = "[TrackGame:TrackGame, RaceType:100, TrackNumber:2]\n" + 
				"[Athletes:[Track1: [[Athlete: name:Chen, age:29, number:7, nation:KOR, personal best:10.12]]][Track2: [[Athlete: name:Park, age:28, number:12, nation:USA, personal best:10.01]]]";
