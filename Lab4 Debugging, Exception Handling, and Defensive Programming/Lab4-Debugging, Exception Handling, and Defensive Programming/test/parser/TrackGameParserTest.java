...
public class TrackGameParserTest extends ParserTest{
	...
	public void testIllegalElementFormatException() {
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_IllegalGame.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), IllegalElementFormatException.class.getName());
		}
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_IllegalANation.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), IllegalElementFormatException.class.getName());
		}
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_NegativeANumber.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), IllegalElementFormatException.class.getName());
		}
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_IllegalAName.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), IllegalElementFormatException.class.getName());
		}
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_IllegalAScore.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), IllegalElementFormatException.class.getName());
		}
	}
	...
	public void testTrackNumberOutOfRangeException() {
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_TrackNumOutofRange.txt");
		} catch(Exception e) {
	...
	public void testLakOfComponentException() {
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_LackPart.txt");
		} catch(Exception e) {
	...
	public void testElementLabelDuplicationException() {
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_RepeatAthlete.txt");
		} catch(Exception e) {
	...
	public void testNoSuchElementException() {
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_NoAthlete.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), NoSuchElementException.class.getName());
		}
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_NoGame.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), NoSuchElementException.class.getName());
		}
		try {
			p.parserFile("src/txt/TG_Exception/TrackGame_NoTrack.txt");
		} catch(Exception e) {
			assertEquals(e.getClass().getName(), NoSuchElementException.class.getName());
		}
	}
